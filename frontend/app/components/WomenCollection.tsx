    ...
    <section style={{ backgroundColor: '#000', color: '#fff', minHeight: '100vh', padding: '110px 5% 50px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #333', paddingBottom: '30px', marginBottom: '40px' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          <h2 style={{ fontSize: '42px', color: '#D4AF37', fontFamily: 'serif', margin: '0 0 10px 0', letterSpacing: '1px' }}>Collection Femmes</h2>
          <p style={{ color: '#888', fontSize: '14px', margin: '0', fontStyle: 'italic' }}>Élégance intemporelle et féminité absolue</p>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '40px', width: '100%' }}>
        ...
        <div style={{ background: '#0a0a0a', border: '1px solid #222', padding: '20px', textAlign: 'center', borderRadius: '12px' }}>
          <div style={{ height: '350px', marginBottom: '20px', overflow: 'hidden', borderRadius: '8px' }}>
            <img src="/image/23.jpg" alt="Rose Impériale" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
          <h3 style={{ fontSize: '24px', color: '#fff', marginBottom: '5px' }}>Rose Impériale</h3>
          <p style={{ color: '#D4AF37', fontSize: '20px', fontWeight: 'bold', marginBottom: '20px' }}>1350 DH</p>
          <button onClick={() => openModal('Rose Impériale', '1350 DH')} className="submit-btn">COMMANDER</button>
        </div>

        {/* Product 2 */}
        <div style={{ background: '#0a0a0a', border: '1px solid #222', padding: '20px', textAlign: 'center', borderRadius: '12px' }}>
          <div style={{ height: '350px', marginBottom: '20px', overflow: 'hidden', borderRadius: '8px' }}>
            <img src="/image/22.jpg" alt="Fleur de Nuit" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
          <h3 style={{ fontSize: '24px', color: '#fff', marginBottom: '5px' }}>Fleur de Nuit</h3>
          <p style={{ color: '#D4AF37', fontSize: '20px', fontWeight: 'bold', marginBottom: '20px' }}>1250 DH</p>
          <button onClick={() => openModal('Fleur de Nuit', '1250 DH')} className="submit-btn">COMMANDER</button>
        </div>

        {/* Product 3 */}
        <div style={{ background: '#0a0a0a', border: '1px solid #222', padding: '20px', textAlign: 'center', borderRadius: '12px' }}>
          <div style={{ height: '350px', marginBottom: '20px', overflow: 'hidden', borderRadius: '8px' }}>
            <img src="/image/24.jpg" alt="Ambre Suprême" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
          <h3 style={{ fontSize: '24px', color: '#fff', marginBottom: '5px' }}>Ambre Suprême</h3>
          <p style={{ color: '#D4AF37', fontSize: '20px', fontWeight: 'bold', marginBottom: '20px' }}>950 DH</p>
          <button onClick={() => openModal('Ambre Suprême', '950 DH')} className="submit-btn">COMMANDER</button>
        </div>
      </div>
